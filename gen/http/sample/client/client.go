...
// Client lists the sample service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the sample service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// Login returns an endpoint that makes HTTP requests to the sample service
// login server.
func (c *Client) Login() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("sample", "login", err)
		}
